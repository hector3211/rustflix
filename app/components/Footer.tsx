...
export default function Footer() {
    return (
        <footer className="text-sm relative bottom-0 w-full flex flex-col md:flex-row md:justify-between items-center py-3 md:py-5 md:pt-5 px-3 md:px-8 lg:px-16">
